...
This file contains all Mermaid diagrams as individual code blocks for easy copy-pasting.

---

## 1. Overview: Full Deployment Pipeline
...
## 2. Phase 1: Dependency Installation (yarn install)
...
## 4. Phase 2: TypeScript Compilation (yarn build)
...
## 6. Phase 3: Lambda Bundling (yarn build:lambda)
...
## 7. esbuild Bundling Process (Detailed)
...
## 9. Phase 4: AWS Deployment (yarn deploy:all)
...
## 12. Data Flow: From TypeScript to Running Lambda
...
## 14. Deployment Script Execution
...
## 15. Lambda Cold Start (After Deployment)
...
## 16. Summary: Why Bundling Matters
...
1. **Copy individual diagram**: Select the code block including ` ```mermaid` and ` ``` `
2. **Paste into**:
...
3. **For presentations**: Export as PNG/SVG from Mermaid Live Editor
